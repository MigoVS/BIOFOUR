...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/fahmi-nabeel-367341278?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    name: "Instagram",
    displayName: "Instagram",
    subText: "chalistaurellia",
    icon: Instagram,
    url: "https://www.instagram.com/chalistaurellia/",
    color: "#E4405F",
    gradient: "from-[#833AB4] via-[#E4405F] to-[#FCAF45]"
  },
  {
    ...
    subText: "@arryyyo",
    icon: Instagram,
    url: "https://www.instagram.com/arryyyo/",
    color: "#E4405F",
    gradient: "from-[#833AB4] via-[#E4405F] to-[#FCAF45]"
  },
  {
